...
## Environments
- Preview: https://main--edsblog--jlopellicer.aem.page/
- Live: https://main--edsblog--jlopellicer.aem.live/
...
1. Open the `edsblog` directory in your favorite IDE and start coding :)
